...
# URL of the chapter
url = "https://www.bible.com/bible/68/JUD.1.GNT"
...
if response.status_code == 200:
    ...
    if not readers:
        ...
        for verse in english_verses:
            ...
            verse_data.append([verse_number, english_text])

        # Save to a CSV file
        filename = "english_bible_verses.csv"
        with open(filename, mode="w", newline="", encoding="utf-8") as file:
            writer = csv.writer(file)
            writer.writerow(["Verse", "English Text"])  # Header
            writer.writerows(verse_data)

        print(f"✅ English verses saved to {filename} successfully!")
